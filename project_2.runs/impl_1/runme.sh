...
HD_PWD='C:/Users/V/Desktop/Car_Maze_Game/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopLevelModule_vga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopLevelModule_vga.tcl -notrace
